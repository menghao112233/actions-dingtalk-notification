...
const success_start_text =
    `### <font color=Green>github发布${process.env.GITHUB_REPOSITORY}完成</font>\n` +
    "|                 | <font color=Darkorange>**before**</font>  | <font color=Green>**after**</font>                  |\n" +
    "| --------------: | ------------- | ---------------------------- |\n";
let markdown_text = "";
const end_text =
    `#### 发布人: ${process.env.GITHUB_ACTOR} \n ` +
    core.getInput("footer_text")
const markdown_data = {
    msgtype: "markdown",
    markdown: {
        title: `github发布${process.env.GITHUB_REPOSITORY}完成`,
        text: ""
    },
    at: {
        isAtAll: false,
...
const fail_start_text =
    `### <font color=Red>github发布${process.env.GITHUB_REPOSITORY}未通过</font>\n` +
